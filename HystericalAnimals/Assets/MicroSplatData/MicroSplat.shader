...
Shader "MicroSplat/Terrain " {
   ...
   SubShader {
      ...
      // people like myself..
      #if defined(SHADER_API_D3D11) || defined(SHADER_API_XBOXONE) || defined(UNITY_COMPILER_HLSLCC) || defined(SHADER_API_PSSL) || (defined(SHADER_TARGET_SURFACE_ANALYSIS) && !defined(SHADER_TARGET_SURFACE_ANALYSIS_MOJOSHADER) && UNITY_VERSION >= 201810)
      ...
      void SampleEmis(Config config, TriplanarConfig tc, inout RawSamples s, float mipLevel)
      {
         #if _USEEMISSIVEMETAL
            #if _TRIPLANAR
...
ENDCG
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain _Base"
